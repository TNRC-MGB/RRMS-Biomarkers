...
# Updated: 7-22-2026
#
# B-cell EBNA2 enrichment - PreRelapse vs Remission (Figure 6 input)
# ==============================================================================
...
# read GMT
#pathways_raw <- fgsea::gmtPathways("output/ebna2_gene_sets.gmt")
pathways_raw <- fgsea::gmtPathways(file.path(EBNA2_DIR, "combined", "ebna2_combined_panel_with_bound_broad.gmt"))
...
celltypes <- names(scdist_bcell_pre$vals)
...
readr::write_csv(fgsea_all, file.path(OUT_DIR, "b_cell_pre_ebna2_fgsea_all.csv"))
readr::write_csv(ora_all,   file.path(OUT_DIR, "b_cell_pre_ebna2_overlap_all.csv"))
readr::write_csv(fora_all,  file.path(OUT_DIR, "b_cell_pre_ebna2_fora_all.csv"))

make_nes_heatmap(fgsea_all, "output/b_cell_pre_ebna2_fgsea_heatmap.pdf")
