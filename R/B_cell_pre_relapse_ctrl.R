...
# Updated: 7-22-2026
#
# B-cell EBNA2 enrichment - host-activation control sets (Figure 6 input)
# ==============================================================================
...
# read GMT
pathways_raw <- fgsea::gmtPathways(file.path(EBNA2_DIR, "control", "host_bcell_activation_controls.gmt"))
...
readr::write_csv(fgsea_all, file.path(OUT_DIR, "b_cell_pre_ebna2_fgsea_all_ctrl.csv"))
readr::write_csv(ora_all,   file.path(OUT_DIR, "b_cell_pre_ebna2_overlap_all_ctrl.csv"))
readr::write_csv(fora_all,  file.path(OUT_DIR, "b_cell_pre_ebna2_fora_all_ctrl.csv"))

make_nes_heatmap(fgsea_all, "output/b_cell_pre_ebna2_fgsea_heatmap_ctrl.pdf")
